...
module.exports.defaultTemplate = survey => {
    ...
    <div>
        ...
        <p style="text-align: center">
            <a style="text-decoration: none; margin-right: 1rem; padding: .5rem 1rem; background-color: #c5ffd2; border-radius: 1rem;" href="${keys.redirectDomain}/services/surveys/${survey._id}/yes/${survey.owner}">Yes</a>
